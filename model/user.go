...
type User struct {
	...
	GmtModified   time.Time `gorm:"column:gmt_modified;type:datetime;default:CURRENT_TIMESTAMP" json:"gmt_modified"` // 修改时间
	GmtCreate     time.Time `gorm:"column:gmt_create;type:datetime;default:CURRENT_TIMESTAMP" json:"gmt_create"`     // 创建时间
